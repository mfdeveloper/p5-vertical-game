export class Platforms {
    ...
    drawWalls() {
        ...
        var wall1 = createSprite(0,  height + (height/2));
        wall1.addImage(this.imgWall);
        wall1.setCollider("rectangle", 1 ,0, 20, 3000);
        this.walls.add(wall1);
        
        var wall2 = createSprite(width - 1, height + (height/2));
        wall2.addImage(this.imgWall);
        wall2.setCollider("rectangle", 1 ,0, 20, 3000);
